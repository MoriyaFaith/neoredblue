	...
	tilepal 0, GRAY, GRAY, BROWN, BROWN, WATER, ROOF, BROWN, BROWN
	tilepal 0, ROOF, BROWN, GREEN, GREEN, ROOF, WATER, WATER, BROWN
	tilepal 0, BROWN, BROWN, BROWN, BROWN, WATER, BROWN, BROWN, ROOF
	tilepal 0, ROOF, BROWN, BROWN, BROWN, BROWN, WATER, WATER, WATER
	tilepal 0, WATER, WATER, BROWN, BROWN, ROOF, ROOF, BROWN, BROWN
	tilepal 0, GRAY, GRAY, WATER, GRAY, BROWN, BROWN, BROWN, WATER
	tilepal 0, BROWN, BROWN, BROWN, BROWN, GREEN, YELLOW, BROWN, BROWN
