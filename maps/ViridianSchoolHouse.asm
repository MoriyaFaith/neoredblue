...
ViridianSchoolHouse_MapEvents:
	...
	def_object_events
    object_event 3, 5, SPRITE_LASS, SPRITEMOVEDATA_STANDING_UP,  0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, School1, EVENT_VIRIDIAN_CITY_GAMBLER
    object_event 4, 1, SPRITE_COOLTRAINER_F, SPRITEMOVEDATA_STANDING_DOWN,  0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, School2, EVENT_VIRIDIAN_CITY_GAMBLER