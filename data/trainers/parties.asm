...
GiovanniGroup:
	...
	db 25, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 24, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 29, RHYDON,     FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db -1 ; end

	; GIOVANNI (1)
	db "GIOVANNI@", TRAINERTYPE_MOVES
	db 37, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 37, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 35, RHYDON,     FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 41, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db -1 ; end

	; GIOVANNI (1)
	db "GIOVANNI@", TRAINERTYPE_MOVES
	db 45, PIDGEOT,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	db 42, ALAKAZAM,   DISABLE, RECOVER, PSYCHIC_M, REFLECT
	db 44, RHYDON,     FURY_ATTACK, SANDSTORM, ROCK_SLIDE, EARTHQUAKE
	db 45, GYARADOS,   TWISTER, HYDRO_PUMP, RAIN_DANCE, HYPER_BEAM
	db 50, EXEGGUTOR,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
	db -1 ; end
