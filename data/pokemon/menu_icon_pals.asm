...
MonMenuIconPals:
	;         normal, shiny
	icon_pals TEAL, GREEN ; BULBASAUR 1
	icon_pals TEAL, GREEN ; IVYSAUR 2
	icon_pals TEAL, GREEN ; VENUSAUR 3
	icon_pals RED, PINK ; CHARMANDER 4
	icon_pals RED, PINK ; CHARMELEON 5
