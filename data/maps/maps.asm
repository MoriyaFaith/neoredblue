...
MapGroup_Viridian:
	...
	map ViridianPokecenter, TILESET_POKECENTER, CAVE, LANDMARK_VIRIDIAN_CITY, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_POND
	map ViridianPokemart, TILESET_POKECENTER, CAVE, LANDMARK_VIRIDIAN_CITY, MUSIC_POKEMART, FALSE, PALETTE_DAY, FISHGROUP_POND
