...
InitializeEventsScript:
	...
	setevent EVENT_RIVAL_CERULEAN_CITY
	...
	setevent EVENT_RIVAL_SS_ANNE
	setevent EVENT_RIVAL_SILPH_CO
	setevent EVENT_RIVAL_FLOE_ISLAND
	...
	setevent EVENT_RIVAL_FORTUNE_ISLAND
