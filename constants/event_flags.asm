...
; Johto story events
	...
	const_skip ; unused
	const_skip ; unused
	const EVENT_GOT_POTION_SAMPLE_FROM_CLERK
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_DOUGGY
...
; Johto itemballs
	...
	const EVENT_ROUTE2_HP_UP
	const EVENT_ROUTE2_MOONSTONE
...
; Johto people
	const EVENT_OAKSLAB_OAK
	const EVENT_RIVAL_OAKSLAB
	const EVENT_VIRIDIAN_CITY_GAMBLER
	const EVENT_RIVAL_ROUTE_22
	const EVENT_RIVAL_CERULEAN_CITY
	const EVENT_RIVAL_SS_ANNE
	const EVENT_RIVAL_SILPH_CO
	const EVENT_RIVAL_FLOE_ISLAND
	const EVENT_RIVAL_FORTUNE_ISLAND
